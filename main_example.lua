...
local Window = AnUI:CreateWindow({
    ...
    OpenButton = {
        Title = "Open .an hub UI", -- can be changed
    ...
    KeySystem = {
        Title = "Key System Example  |  AnUI Example",
...
do -- config elements
    ...
    -- All elements are taken from the official documentation: https://AdityaNugraha.github.io/AnUI-Docs/docs
