...
function TabModule.Init(WindowTable, AnUITable, ToolTipParent, TabHighlight)
    Window = WindowTable
    AnUI = AnUITable
...
function TabModule.New(Config, UIScale)
    ...
    Tab.ElementsModule.Load(Tab, Tab.UIElements.ContainerFrame, Tab.ElementsModule.Elements, Window, AnUI, nil, Tab.ElementsModule, UIScale)
