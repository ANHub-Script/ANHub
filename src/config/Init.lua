...
function ConfigManager:Init(WindowTable)
    ...
    ConfigManager.Path = "AnUI/" .. tostring(ConfigManager.Folder) .. "/config/"
    
    if not isfolder("AnUI/" .. ConfigManager.Folder) then
        makefolder("AnUI/" .. ConfigManager.Folder)
        if not isfolder("AnUI/" .. ConfigManager.Folder .. "/config/") then
            makefolder("AnUI/" .. ConfigManager.Folder .. "/config/")
        end
    end
